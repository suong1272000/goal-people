    ...
    <div className="w-screen mt-16 h-300vh landscape:max-2xl:h-400vh">
      <div className="w-full h-full bg-white">
        ...
        >
          ...
          <div className="w-full flex justify-between mt-32 items-center max-2xl:flex-col">
            <div
              className="bg-soccer-player bg-cover bg-center"
              style={{ width: '600px', height: '600px' }}
            />
            <div>
              <div className="flex flex-col my-20 text-2xl font-WavvePADO gap-3  max-2xl:items-center max-2xl:text-4xl max-2xl:gap-10">
                <p>축구를 즐기는 사람!</p>
                <p>배우려는 사람!</p>
                <p>선출 없는 팀</p>
                <p>성인이라면 누구나 가능합니다!</p>
              </div>
              <div className="max-2xl:flex max-2xl:text-center max-2xl:text-2xl max-2xl:mx-24">
          ...
          <div className="w-full mt-12  border border-solid border-zinc-300 border-t-0 max-2xl:w-5/6"></div>
          <div id="grid" className="mt-20 max-2xl:text-lg max-2xl:mx-20">
            <div className="grid grid-cols-4">
              <div className="border-r border-gray-200 p-4 border-l-0"></div>
              <div className="border-r border-gray-200 p-4 font-bold max-2xl:text-lg">
                취미반
              </div>
              <div className="border-r border-gray-200 p-4 font-bold max-2xl:text-lg">
                성인반
              </div>
              <div className="border-gray-200 p-4 border-l-1 font-bold max-2xl:text-lg">
                그룹반(4명~)
              </div>
              <div className="border-y border-r border-gray-200 p-4 border-l-0 font-bold max-2xl:text-lg">
                1회권
              </div>
              ...
              <div className="border-b border-r border-gray-200 p-4 border-l-0 font-bold max-2xl:text-lg">
                5회권
              </div>
              ...
              <div className="border-b border-gray-200 p-4">-</div>
              <div className="border-r border-gray-200 p-4 border-l-0 font-bold max-2xl:text-lg">
                15회권
              </div>
          ...
          <div className="mx-20 my-10">
            <h2 className="text-xl mb-5 max-2xl:text-3xl max-2xl:mb-10 max-2xl:mt-20">
              ※ 수업 내용
            </h2>
            <div className="flex flex-col gap-3 max-2xl:text-xl">
            ...
            <h2 className="text-xl mb-5 mt-10 max-2xl:text-3xl max-2xl:mb-10 max-2xl:mt-20">
              ※ 수업 일정
            </h2>
            <div className="flex flex-col gap-3 max-2xl:text-xl">
              <p>
