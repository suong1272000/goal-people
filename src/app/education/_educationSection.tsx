const EducationSection = () => {
  return (
    <div className="w-screen mt-16" style={{ height: '300vh' }}>
      <div className="w-full h-full bg-white">
        <div className="w-full h-96 bg-top-bg bg-center bg-cover flex items-center justify-center">
          <div className="text-white flex flex-col items-center mt-12">
            <h2 className="text-6xl py-6 font-Giants-Inline">Education</h2>
        ...
        >
          <div className="flex flex-col items-center mt-20">
            ...
            <h2 className="text-3xl mt-2 font-MaruBuri">자격 조건</h2>
          </div>
          <div className="w-full mt-12  border border-solid border-zinc-300 border-t-0"></div>
          <div className="w-full flex justify-between mt-32 items-center">
            <div
              className="bg-soccer-player bg-cover bg-center"
              style={{ width: '600px', height: '600px' }}
            />
            <div>
              <div className="flex flex-col my-20 text-2xl font-WavvePADO gap-3">
                <p>축구를 즐기는 사람!</p>
                <p>배우려는 사람!</p>
                <p>선출 없는 팀</p>
                <p>성인이라면 누구나 가능합니다!</p>
          ...
          <div className="flex flex-col items-center mt-40">
            <h2 className="text-3xl mt-2 font-MaruBuri">교육비 안내</h2>
          </div>
          <div className="w-full mt-12  border border-solid border-zinc-300 border-t-0"></div>
          <div id="grid" className="mt-10">
            <div className="grid grid-cols-4">
              <div className="border-r border-gray-200 p-4 border-l-0"></div>
              <div className="border-r border-gray-200 p-4 font-bold">
                취미반
              </div>
              <div className="border-r border-gray-200 p-4 font-bold">
                성인반
              </div>
              <div className="border-gray-200 p-4 border-l-1 font-bold">
                그룹반(4명~)
              </div>
              <div className="border-y border-r border-gray-200 p-4 border-l-0 font-bold">
                1회권
              </div>
              ...
              <div className="border-b border-r border-gray-200 p-4 border-l-0 font-bold">
                5회권
              </div>
              ...
              <div className="border-b border-gray-200 p-4">-</div>
              <div className="border-r border-gray-200 p-4 border-l-0 font-bold">
                15회권
              </div>
          ...
          <div className="flex flex-col items-center mt-40">
            <h2 className="text-3xl mt-2 font-MaruBuri">교육시간 안내</h2>
          </div>
          <div className="w-full mt-12  border border-solid border-zinc-300 border-t-0" />
          <div className="mx-20 my-10">
            <h2 className="text-xl mb-5">※ 수업 내용</h2>
            ...
            <h2 className="text-xl mb-5 mt-10">※ 수업 일정</h2>
            <div className="flex flex-col gap-3">
              <p>
            ...
            <h2 className="text-xl mb-5 mt-10">※ 혜택</h2>
            <div className="flex flex-col gap-3">
              <p>
